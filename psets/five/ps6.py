...
class Message(object):
    ...
    def build_shift_dict(self, shift):
        ...
        for i in range(26):
            newPos = (i + shift) % 26
            currentLetter = string.ascii_lowercase[i]
            newLetter = string.ascii_lowercase[newPos]
            encrypt[currentLetter] = newLetter
            encrypt[currentLetter.upper()] = newLetter.upper()
    ...
    def apply_shift(self, shift):
        ...
        '''
        encryptDict = self.build_shift_dict(shift)
        encryptedMsg = ''
        for letter in self.message_text:
            try:
                encryptedMsg += encryptDict[letter]
            except KeyError: 
